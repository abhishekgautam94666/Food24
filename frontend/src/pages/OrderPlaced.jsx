    ...
    return (
        <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
            ...
            <p className='text-gray-600 max-w-md mb-6'>
                ...
                u can track your order status in the "My Orders" section
            </p>
            <button onClick={() => navigate("/my-orders")} className='bg-[#ff4d2d] hover:[#e64526] text-white px-6 py-3 rounded-lg text-lg font-medium transition'>Back to my order</button>
        </div>
    )
}
